        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <div className="bg-card p-6 rounded-lg border">
              <p>
                <strong>Nom commercial :</strong> DevFreelance.pro
              </p>
              <p>
              ...
              <p>
                <strong>Email :</strong> contact@devfreelance.pro
              </p>
              <p>
          ...
          <section>
            ...
            <p>
              Le directeur de la publication du site DevFreelance.pro est le
          ...
          <section>
            ...
            <div className="bg-card p-6 rounded-lg border">
              <p>
                <strong>Hébergeur :</strong> Serge AHOUANSINOU
              </p>
              <p>
                <strong>Adresse :</strong> [Adresse de Serge AHOUANSINOU]
              </p>
              <p>Le site est hébergé sur la plateforme Serge AHOUANSINOU.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-card p-6 rounded-lg border">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>eGuardImmo :</strong> Application de gestion
                  immobilière
                </li>
                <li>
                  <strong>Ma Consolation :</strong> Application de services de
                  consolation
                </li>
              </ul>
              <p className="mt-4 text-sm text-muted-foreground">
                Ces applications sont des créations originales développées par
                DevFreelance.pro. Toute reproduction ou utilisation sans
          ...
          <section>
            ...
            <p>
              ...
              l'adresse contact@devfreelance.pro, en décrivant le problème de la
          ...
          <section>
            ...
            <p>
              Les présentes conditions du site DevFreelance.pro et votre
              utilisation de ce site sont régies par le droit français. Tout
              litige portant sur l'utilisation du site est soumis au droit
              français.
            </p>
          </section>
